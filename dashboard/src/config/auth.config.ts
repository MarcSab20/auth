...
export const AUTH_CONFIG = {
  ...
  // URLs des applications - PORTS COHÉRENTS AVEC AUTH
  AUTH_URL: process.env.NEXT_PUBLIC_AUTH_URL || 'http://localhost:3000',      // Port fixe pour auth
  DASHBOARD_URL: process.env.NEXT_PUBLIC_DASHBOARD_URL || 'http://localhost:3002', // Port fixe pour dashboard
...
export function validateAuthConfig(): void {
  const required = [
    { key: 'DASHBOARD_APP.APP_ID', value: AUTH_CONFIG.DASHBOARD_APP.APP_ID },
    { key: 'DASHBOARD_APP.APP_SECRET', value: AUTH_CONFIG.DASHBOARD_APP.APP_SECRET },
