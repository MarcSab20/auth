import "@/src/app/css/star/style.css";
import { Suspense, useState } from "react";
import { motion, Variants, Transition } from "framer-motion";
import { StarIcon } from "./Star";

export default function SMPServiceMainStaring() {
  ...
  return (
    <motion.button
      ...
      className="like-button" /* Assurez-vous que la classe est bien appliquée */
    >
      <motion.div
        className="icon"
        variants={{
...
const buttonVariants: Variants = {
  ...
  hover: {
    ...
    scale: 1.02,  // Échelle ajustée pour ne pas déborder
    y: -8
  },
  press: { 
    scale: 0.94 // Réduction de l'échelle
  }
};
