...
export const metadata: Metadata = {
  ...
  description: 'Gérez la comptabilité de vos fournisseurs',
};

export default async function SuppliersAccountingPage({ params }: { params: { organizationID: string } }) {
  try {
    ...
    return (
      <div className="space-y-6">
        ...
        <AccountingTabs organizationID={params.organizationID} view="suppliers" />
      </div>
    );
  } catch (error) {
